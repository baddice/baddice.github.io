...
function (_React$Component4) {
  ...
  function Dice() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "handleBetAmountChange", function (event) {
      ...
      if (value === '') {
        _this3.props.dispatch(_redux__WEBPACK_IMPORTED_MODULE_14__["actions"].updateBetAmount(0.1));
      }
    });
  ...
  _createClass(Dice, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        value: betAmount === '' ? betAmount : parseFloat(betAmount).toFixed(2),
...
//# sourceMappingURL=dice.js.175c923befba519779fd.hot-update.js.map
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log('connected', connected); // If the user does not have Scatter or it is Locked or Closed this will return false;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                console.log('getInstance starts');

                if (!(instance == null && !semaphore)) {
                  _context5.next = 8;
                  break;
                }

                console.log('new eos client', semaphore);
                instance = new EosClient();
                _context5.next = 6;
                return instance.init();

              case 6:
                console.log('instance.init() done');
                semaphore = true;
...
//# sourceMappingURL=dice.js.991918be813e77da072a.hot-update.js.map